...
export const shikiTheme = {
  ...
  tokenColors: [
    {scope: 'comment', settings: {foreground: colors.gray, fontStyle: 'italic'}},
    {scope: 'string', settings: {foreground: colors.green}},
    {scope: 'constant.character.escape', settings: {foreground: colors.cyan}},
